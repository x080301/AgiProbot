...
def object_grouping(object_list):
    ...
    object_dict['Electrical Connector'].append('5555_Cylinder_' + str(max_cylinder_id - 5))
    object_list.remove('5555_Cylinder_' + str(max_cylinder_id - 5))
    object_dict['Electrical Connector'].append('5555_Cylinder_' + str(max_cylinder_id - 6))
