...
class PointNet2Segmentation(nn.Module):
    def __init__(self, num_segmentation_class):
        ...
        self.conv2 = nn.Conv1d(128, num_segmentation_class, 1)

    def forward(self, xyz):  # input (B,C,N)
        l0_points = xyz
        l0_xyz = xyz[:, :3, :]
...
if __name__ == '__main__':
    model = PointNet2Segmentation(num_segmentation_class=13)
