...
def fps_open3d(points, num_samples):
...
for file_name in os.listdir(file_dir):
    ...
    for point_cloud_index in range(16):
        ...
        pc_1024 = fps_open3d(pc_2048, 1024).reshape((-1, 1, 3))
        pc_512 = fps_open3d(pc_2048, 512).reshape((-1, 1, 3))
        pc_256 = fps_open3d(pc_2048, 256).reshape((-1, 1, 3))
        pc_128 = fps_open3d(pc_2048, 128).reshape((-1, 1, 3))
        pc_64 = fps_open3d(pc_2048, 64).reshape((-1, 1, 3))
        pc_32 = fps_open3d(pc_2048, 32).reshape((-1, 1, 3))
        pc_16 = fps_open3d(pc_2048, 16).reshape((-1, 1, 3))
