...
from utilities.util import index_points
import torch
...
class MotorDataset(Dataset):
    def __init__(self, split='train', data_root='directory to training data_process', num_class=6, num_points=4096,
...
class MotorDataset_patch(Dataset):
    def __init__(self, split='train', data_root='directory to training data_process', num_points=4096, test_area='Validation',
